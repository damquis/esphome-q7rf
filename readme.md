...
This branch controls ony zone 3. If you need to control an another zone switch to the corresponding branch. If you want to control multiple zones check the [multizone brach](https://github.com/damquis/esphome-q7rf/tree/multizone).
...
Add this component using the following configuration in your node's yaml file:
    ...
    external_components:
      - source: github://damquis/esphome-q7rf@zone3
        components: [ q7rf ]
